...
; is this slope or radius??
     iradii_out[]  fillarray 0.0075  ; slopes of cone segments
...
; resonator creates wrong sound
     ay tube_resonator 0.03*asig+adelay[kpos]*kg, kLength, icone_lengths, iradii_in, iradii_out, icurve_type
...
; this resonator works
     ...
     ;ay, aSound halfphysler 0.03*asig+adelay[kpos]*kg, kLength_m, kCylinder_Radius_m, kSlope, kEndReflection, kDensity, kPos
